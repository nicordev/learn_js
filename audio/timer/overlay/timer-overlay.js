...
function createCloseButton(targetElement) {
    ...
    closeButtonElement.style = "float: right;";
...
function displayOverlay(elements) {
    ...
    overlayElement.appendChild(createCloseButton(overlayElement));
...
function createTimerInput(id) {
    ...
    inputElement.innerHTML = `<input type="number" id="${id}" value="0" style="margin: 0.5em;" />`;
...
function createTimerName() {
    const nameElement = document.createElement("div");

    nameElement.innerHTML = `<input type="text" style="margin: 0.5em;" />`;
...
function initTimer() {
    ...
    timerElement.appendChild(createTimerName());
