...
function getDataToImport() {
    let dataToImport = document.getElementById('import-data').value;
    
    return JSON.parse(dataToImport);
}
...
document
    ...
    .addEventListener('click', function (event) {
        let notes = getDataToImport();
        // notes = [{ "title": "note1" }, { "title": "note2" }, { "title": "note3" }];
